#!/usr/bin/env python3
"""
Extract Scube1 + cell marker expression for ventral striatum from ABC Atlas 10x.
...
Region: STRv (ventral striatum / nucleus accumbens)
"""
import os
import gc
import time
...
region_acronym = 'STRv'
output_csv = Path('strv_scube1_expression.csv')
output_meta = Path('strv_scube1_metadata.csv')
