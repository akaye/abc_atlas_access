#!/usr/bin/env python3
"""
Extract Scube1 + cell marker expression for pallidum from ABC Atlas 10x.
...
Region: PAL (pallidum — includes GPe, GPi, VP, etc.)
"""
import os
import gc
import time
...
region_acronym = 'PAL'
output_csv = Path('pal_scube1_expression.csv')
output_meta = Path('pal_scube1_metadata.csv')
