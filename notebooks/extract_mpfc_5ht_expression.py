#!/usr/bin/env python3
"""
Extract serotonin receptor + cell marker expression for mPFC from ABC Atlas 10x.
...
Region: PL-ILA-ORB (prelimbic, infralimbic, orbital — mPFC)
"""
import os
import gc
import time
...
region_acronym = 'PL-ILA-ORB'
output_csv = Path('mpfc_5ht_expression.csv')
output_meta = Path('mpfc_5ht_metadata.csv')
